...
exec(open("zillion_baseball/version.py").read())

setup(
    name="zillion_baseball",
    description="Use Zillion to analyze baseball stats",
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://github.com/totalhack/zillion_baseball",
    author="totalhack",
    ...
    scripts=find_deploy_scripts(
        "zillion_baseball", ["\\*.py", "\\*.sh", "\\*.sql"], ["__init__"]
    ),
